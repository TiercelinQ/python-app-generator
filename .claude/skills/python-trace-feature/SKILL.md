---
name: python-trace-feature
description: Analyze code, architecture, data flow, or behavior in a Python/PySide6 app generated by this framework. Use when the user asks to understand, trace, audit, or investigate how something works across the model / controller / view layers.
model: sonnet
---

# /python-trace-feature — Analyze a generated Python/PySide6 app
...
- **Do not** modify code during an analysis. This skill is read-only; if a fix is wanted, hand off to `/python-fix-issue` or `/python-add-feature`.
