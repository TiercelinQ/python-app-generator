...
# /trace-feature — Analyze a generated Python/PyQt6 app
...
- **"Is this well-architected?"** → compare against `docs/specs/04-architect.md` and `rules/mvc.md`; report deviations, do not refactor (that is `/refactor-code`, on request).
