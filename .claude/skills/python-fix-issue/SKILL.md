...
description: Fix a bug, ruff/mypy error, runtime exception, DB/migration issue, or QSS/design deviation in a Python/PySide6 app generated by this framework. Use when the user reports something broken or failing. Targets the root cause, never a workaround.
model: sonnet
---
