...
> Built on `design-system.md v1.4`. The two files are inseparable.
...
This file does not redefine tokens — it consumes them. Every visual value is traced to `design-system.md v1.4`.
